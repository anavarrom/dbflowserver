...
public class SafeKeepingProjectResource {
    ...
    private static final String ENTITY_NAME = "dbFlowServerSafeKeepingProject";
     ...
     */
    @PostMapping("/safe-keeping-projects")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/safe-keeping-projects")
     ...
     */
    @GetMapping("/safe-keeping-projects")
     ...
     */
    @GetMapping("/safe-keeping-projects/{id}")
     ...
     */
    @DeleteMapping("/safe-keeping-projects/{id}")
